        ...
        <div className={`${styles.paddingX} ${styles.paddingY} h-auto w-full container mx-auto`}>
            <div className="flex flex-wrap items-center justify-center">
                ...
                <div
                    ...
                    <div className="flex  ml-20 text-lg  font-semibold w-56"> Hiranandani Medows, thane , mumbai - 400610
                    </div>
                    ...
                    <div className="flex  ml-20 text-lg  font-semibold w-40">+44 1234567890
                    </div>
                    ...
                    <div className="flex  ml-20 text-lg  font-semibold w-40">
                        info@acme.org
                    </div>
                    <div className="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                    ...
                    target="_blank"
                    className="mt-4 text-white bg-orange-600 hover:bg-orange-300 focus:ring-4 focus:ring-orange-200 font-medium rounded-lg text-lg px-5 py-2.5 text-center shadow-xl shadow-black  ">SCHEDULE MY 30 MN FREE CONSULTATION</Link>
                    </div>
                </div>
