...
const Socials = () => {
  return (
    <nav className={`${styles.paddingX
      } w-full hidden lg:flex items-center py-2 top-0 z-20 bg-orange-500`}>
      ...
      <Link
        ...
        <Link
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='flex items-center gap-2 ml-7 text-blue-600 '
          onClick={() => {
            window.scrollTo(0, 0);
          }}
        >
        ...
        <Link
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='flex items-center gap-2 ml-7 text-pink-950'
          onClick={() => {
            window.scrollTo(0, 0);
          }}>
        ...
        <Link
          ...
          target='_blank'
          rel='noopener noreferrer'
          className='flex items-center gap-2 ml-7 text-sky-600'
          onClick={() => {
            window.scrollTo(0, 0);
          }}>
          <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-7 h-7" viewBox="0 0 24 24">
