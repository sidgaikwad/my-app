    ...
    return (
        <section className="">
            ...
            <img src={img1} alt="" className="lg:h-[300px] lg:w-[750px] h-[150px] w-[375px] shadow-xl shadow-black my-4 mx-auto" />
                    ...
                    <h2 className="lg:text-4xl text-2xl text-orange-500 font-bold text-left underline py-4">Results Achieved: </h2>
                    <div className="flex flex-col justify-center items-center lg:mx-24 mx-7">
                    ...
                    {/* <h1 className="font-bold text-4xl text-orange-500 underline text-left ">
                    Conclusion:
                    </h1> */}
                    <p className="lg:text-2xl text-xl text-black font-light  mb-12  ">   
                    <b className="text-2xl text-black underline font-semibold mr-4">Conclusion:</b>
