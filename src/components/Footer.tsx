        ...
        <footer className="bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className='flex items-center gap-2'
                            ...
                            <img src={logo} className="h-12 mr-3" alt="DigitalLoop Logo" />
                    ...
                    <div className="grid  gap-8 sm:gap-6 grid-cols-2">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link to="https://www.instagram.com/digitalloopmarketing/"
                                        rel="noreferrer noopener"
                                        target="_blank"
                                        className="hover:underline ">Instagram</Link>
                                </li>
                                <li>
                                    <Link to="https://youtube.com/@vedanttewari3944"
                                        rel="noreferrer noopener"
                                        target="_blank"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">DigitalLoopMRK</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <Link to="https://www.facebook.com/digitalloopmarketing/" className="text-gray-500  hover:text-blue-500">
                        ...
                        <Link to="https://www.instagram.com/digitalloopmarketing/" className="text-gray-500  hover:text-pink-500">
                        ...
                        <Link to="https://youtube.com/@vedanttewari3944" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
